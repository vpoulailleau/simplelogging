...
The sources for Simple Logging can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/vpoulailleau/simplelogging
.. _tarball: https://github.com/vpoulailleau/simplelogging/tarball/master
